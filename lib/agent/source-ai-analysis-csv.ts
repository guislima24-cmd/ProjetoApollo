...
export async function analyzeCsvLead(params: {
  ...
  const { nome, setor, cidade, funcionarios, website, linkedin_url, website_text, linkedin_text } = params
...
score_fit: número inteiro de 1 a 10 (10 = fit perfeito com UFABC Júnior — empresa de engenharia com desafios técnicos complexos).`
